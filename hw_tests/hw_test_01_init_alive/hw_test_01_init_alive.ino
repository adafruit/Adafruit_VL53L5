 ...
 *
 * Hardware test: VL53L5CX initialization and basic readback
 *
 * Tests:
...
void setup() {
  ...
  uint32_t intTime = vl53l5cx.getIntegrationTime();
  ...
  bool startOk = vl53l5cx.startRanging();
  ...
  if (dataReady) {
    ...
    bool readOk = vl53l5cx.getRangingData(&results);
